...
([[OMNITargetKeyPath alloc] initWithTarget:OBJ keyPath:(((void)(NO && ((void)OBJ.PATH, NO)), @# PATH))])
...
([[OMNITargetKeyPath alloc] initWithTarget:OBJ keyPath:PATH])

/*
 You should typically not create this object yourself. Use the macros above instead.
 */
@interface OMNITargetKeyPath : NSObject
